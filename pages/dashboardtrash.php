    ...
    <div class="col">
      <div class="sidenav flex-column p-1 bg-primary" style="width: 160px;">
        <ul class="nav nav-pills flex-column mb-auto my-5 py-5">
          ...
          <li>
            <a class="nav-link link-dark" href="dashboarddraft.php" data-bs-toggle="tab">
          ...
          <li>
            <a class="nav-link link-dark" href="dashboardtrash.php" onclick="return trashfun()" data-bs-toggle="tab" >
